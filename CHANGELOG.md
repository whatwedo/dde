...
- Worktree routers with explicit service references now route to the worktree backend. ([#302](https://github.com/whatwedo/dde/pull/302)) See [Worktrees](docs/guides/worktrees.md).
