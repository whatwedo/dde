...
- Worktree containers keep their own Traefik network even when Compose labels select another network. ([#304](https://github.com/whatwedo/dde/pull/304)) See [Worktrees](docs/guides/worktrees.md).
