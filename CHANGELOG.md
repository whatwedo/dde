...
- Custom Traefik router and backend names no longer collide between a project and its worktrees. ([#306](https://github.com/whatwedo/dde/pull/306)) See [Worktrees](docs/guides/worktrees.md).
