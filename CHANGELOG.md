...
- Worktrees with overlapping project or directory names now use separate Docker networks. ([#303](https://github.com/whatwedo/dde/pull/303)) See [Worktrees](docs/guides/worktrees.md).
